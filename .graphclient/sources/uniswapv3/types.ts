...
export namespace Uniswapv3Types {
  ...
  export type QuerySdk = {
    ...
    >;
    /** null **/
    positionSnapshot: InContextSdkMethod<
      Query["positionSnapshot"],
      QuerypositionSnapshotArgs,
      MeshContext
    >;
    /** null **/
    positionSnapshots: InContextSdkMethod<
    ...
    /** null **/
    collect: InContextSdkMethod<
      Query["collect"],
      QuerycollectArgs,
      MeshContext
    >;
    /** null **/
    collects: InContextSdkMethod<
      Query["collects"],
      QuerycollectsArgs,
      MeshContext
    >;
    ...
    >;
    /** null **/
    poolDayData: InContextSdkMethod<
      Query["poolDayData"],
      QuerypoolDayDataArgs,
      MeshContext
    >;
    /** null **/
    poolDayDatas: InContextSdkMethod<
      Query["poolDayDatas"],
      QuerypoolDayDatasArgs,
      MeshContext
    >;
    /** null **/
    poolHourData: InContextSdkMethod<
      Query["poolHourData"],
      QuerypoolHourDataArgs,
      MeshContext
    >;
    /** null **/
    poolHourDatas: InContextSdkMethod<
      Query["poolHourDatas"],
      QuerypoolHourDatasArgs,
      MeshContext
    >;
    /** null **/
    tickHourData: InContextSdkMethod<
      Query["tickHourData"],
      QuerytickHourDataArgs,
      MeshContext
    >;
    /** null **/
    tickHourDatas: InContextSdkMethod<
      Query["tickHourDatas"],
      QuerytickHourDatasArgs,
      MeshContext
    >;
    /** null **/
    tickDayData: InContextSdkMethod<
      Query["tickDayData"],
      QuerytickDayDataArgs,
      MeshContext
    >;
    /** null **/
    tickDayDatas: InContextSdkMethod<
      Query["tickDayDatas"],
      QuerytickDayDatasArgs,
      MeshContext
    >;
    /** null **/
    ...
    >;
    /** null **/
    tokenHourData: InContextSdkMethod<
      Query["tokenHourData"],
      QuerytokenHourDataArgs,
      MeshContext
    >;
    /** null **/
    tokenHourDatas: InContextSdkMethod<
  ...
  export type SubscriptionSdk = {
    ...
    >;
    /** null **/
    pool: InContextSdkMethod<
      Subscription["pool"],
      SubscriptionpoolArgs,
      MeshContext
    >;
    /** null **/
    pools: InContextSdkMethod<
      Subscription["pools"],
      SubscriptionpoolsArgs,
      MeshContext
    >;
    /** null **/
    tick: InContextSdkMethod<
      Subscription["tick"],
      SubscriptiontickArgs,
      MeshContext
    >;
    /** null **/
    ticks: InContextSdkMethod<
      Subscription["ticks"],
      SubscriptionticksArgs,
      MeshContext
    >;
    /** null **/
    position: InContextSdkMethod<
    ...
    /** null **/
    positionSnapshot: InContextSdkMethod<
      Subscription["positionSnapshot"],
      SubscriptionpositionSnapshotArgs,
      MeshContext
    >;
    /** null **/
    positionSnapshots: InContextSdkMethod<
      Subscription["positionSnapshots"],
    ...
    >;
    /** null **/
    mint: InContextSdkMethod<
      Subscription["mint"],
      SubscriptionmintArgs,
      MeshContext
    >;
    /** null **/
    mints: InContextSdkMethod<
      Subscription["mints"],
      SubscriptionmintsArgs,
      MeshContext
    >;
    /** null **/
    burn: InContextSdkMethod<
      Subscription["burn"],
      SubscriptionburnArgs,
      MeshContext
    >;
    /** null **/
    burns: InContextSdkMethod<
      Subscription["burns"],
      SubscriptionburnsArgs,
      MeshContext
    >;
    /** null **/
    swap: InContextSdkMethod<
      Subscription["swap"],
      SubscriptionswapArgs,
      MeshContext
    >;
    /** null **/
    swaps: InContextSdkMethod<
      Subscription["swaps"],
    ...
    collect: InContextSdkMethod<
      ...
      SubscriptioncollectArgs,
      MeshContext
    >;
    /** null **/
    collects: InContextSdkMethod<
      Subscription["collects"],
      SubscriptioncollectsArgs,
      MeshContext
    >;
    /** null **/
    flash: InContextSdkMethod<
      Subscription["flash"],
      SubscriptionflashArgs,
      MeshContext
    >;
    /** null **/
    flashes: InContextSdkMethod<
      Subscription["flashes"],
      SubscriptionflashesArgs,
      MeshContext
    >;
    /** null **/
    uniswapDayData: InContextSdkMethod<
    ...
    /** null **/
    poolDayData: InContextSdkMethod<
      Subscription["poolDayData"],
      SubscriptionpoolDayDataArgs,
      MeshContext
    >;
    /** null **/
    poolDayDatas: InContextSdkMethod<
      Subscription["poolDayDatas"],
      SubscriptionpoolDayDatasArgs,
      MeshContext
    >;
    /** null **/
    poolHourData: InContextSdkMethod<
      Subscription["poolHourData"],
      SubscriptionpoolHourDataArgs,
      MeshContext
    >;
    /** null **/
    poolHourDatas: InContextSdkMethod<
      Subscription["poolHourDatas"],
      SubscriptionpoolHourDatasArgs,
      MeshContext
    >;
    /** null **/
    tickHourData: InContextSdkMethod<
      Subscription["tickHourData"],
      SubscriptiontickHourDataArgs,
      MeshContext
    >;
    /** null **/
    tickHourDatas: InContextSdkMethod<
      Subscription["tickHourDatas"],
      SubscriptiontickHourDatasArgs,
      MeshContext
    >;
    /** null **/
    tickDayData: InContextSdkMethod<
      Subscription["tickDayData"],
      SubscriptiontickDayDataArgs,
      MeshContext
    >;
    /** null **/
    tickDayDatas: InContextSdkMethod<
      Subscription["tickDayDatas"],
    ...
    /** null **/
    tokenHourData: InContextSdkMethod<
      Subscription["tokenHourData"],
      SubscriptiontokenHourDataArgs,
      MeshContext
    >;
    /** null **/
    tokenHourDatas: InContextSdkMethod<
      Subscription["tokenHourDatas"],
