...
const merger = new(BareMerger as any)({
  ...
  return {
    ...
    get documents() {
      return [
      {
        document: TopPoolByTvlDocument,
        get rawSDL() {
          return printWithCache(TopPoolByTvlDocument);
        },
        location: 'TopPoolByTvlDocument.graphql'
      }
    ];
    },
    fetchFn,
...
export function getSdk<C, E>(requester: Requester<C, E>) {
  return {
    TopPoolByTVL(variables?: TopPoolByTVLQueryVariables, options?: C): Promise<TopPoolByTVLQuery> {
      return requester<TopPoolByTVLQuery, TopPoolByTVLQueryVariables>(TopPoolByTVLDocument, variables, options) as Promise<TopPoolByTVLQuery>;
    }
  };
}
