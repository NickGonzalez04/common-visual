...
export type getTopPoolsByTVLQuery = { pools: Array<(
    Pick<Pool, 'id' | 'totalValueLockedUSD'>
    & { token0: Pick<Token, 'id' | 'symbol' | 'name'>, token1: Pick<Token, 'id' | 'symbol' | 'name'>, poolDayData: Array<Pick<PoolDayData, 'id' | 'volumeUSD'>> }
  )> };
...
export type getTokensQuery = { tokens: Array<(
    Pick<Token, 'id' | 'symbol' | 'name' | 'totalValueLockedUSD' | 'volumeUSD'>
...
export const getTopPoolsByTVLDocument = gql`
  ...
  pools(
    ...
    ` as unknown as DocumentNode<getTopPoolsByTVLQuery, getTopPoolsByTVLQueryVariables>;
...
export function getSdk<C, E>(requester: Requester<C, E>) {
  return {
    getTopPoolsByTVL(variables?: getTopPoolsByTVLQueryVariables, options?: C): Promise<getTopPoolsByTVLQuery> {
      return requester<getTopPoolsByTVLQuery, getTopPoolsByTVLQueryVariables>(getTopPoolsByTVLDocument, variables, options) as Promise<getTopPoolsByTVLQuery>;
    },
